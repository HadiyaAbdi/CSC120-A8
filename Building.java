public class Building {
    ...
    public Building(String name, String address) {
        this(name, address, 1,true); // Call full constructor with hard-coded # floors
    }
    ...
    public void goDown() {
        if (this.activeFloor <= -1) {
            throw new RuntimeException("Must call enter() before navigating between floors.");
        }
        this.goToFloor(this.activeFloor - 1);
    }
    ...
    System.out.println(" + goToFloor(floorNum)");
